      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
        <Container>
          ...
          <div className="navbar-nav d-none d-lg-flex flex-row me-auto ms-5">
            ...
            <a className="nav-link px-3 fw-medium" href="#" style={{ color: '#717171' }}>Características</a>
            <a className="nav-link px-3 fw-medium" href="#" style={{ color: '#717171' }}>Productos</a>
            <a className="nav-link px-3 fw-medium" href="#" style={{ color: '#717171' }}>Acerca de</a>
          ...
          <Row className="align-items-center min-vh-75">
            <Col lg={6} className="pe-lg-5">
              <h1 className="display-4 fw-bold mb-4" style={{ color: '#2E2E2E' }}>
                Conecta con los mejores <span style={{ color: '#4CAF50' }}>profesionales</span>
              </h1>
              <p className="fs-5 text-muted mb-4">
                Descubre una plataforma moderna que conecta talento con oportunidades
              </p>
              <Button
                onClick={() => navigate('/register')}
